...
1. [Chapter I](#chapter-i) \
   ...
   1.3. [Утилита iperf1](#part-1-утилита-iperf1) \
...
##### 1) Адрес сети *192.167.18.54/11*
##### 2) Перевод маски *255.255.255.0* в префиксную и двоичную запись, */15* в обычную и двоичную, *11111111.11111111.11111111.11110000* в обычную и префиксную
##### 1) Минимальный и максимальный хост в сети *12.167.18.4* при масках: */8*, *11111111.11111111.00000000.00000000*, *255.255.254.0* и */4*

#### 1.2. localhost
##### Определи и запиши в отчёт, можно ли обратиться к приложению, работающему на localhost, со следующими IP: *194.14.21.100*, *127.0.0.2*, *127.1.0.1*, *128.0.0.1*

#### 1.1. Диапазоны и сегменты сетей
##### Определи и запиши в отчёт:
##### 1) Какие из перечисленных IP можно использовать в качестве публичного, а какие только в качестве частных: *10.0.0.45*, *114.41.0.2*, *192.168.4.2*, *172.20.250.4*, *172.0.2.1*, *192.172.0.1*, *172.68.0.2*, *172.16.255.255*, *10.10.10.10*, *192.169.168.1*
...
##### 1) Открой на машинах доступ для порта 22 (ssh) и порта 80 (http).
...
##### Подними пять виртуальных машин (1 рабочие станции (ws11, ws21, ws22) и 2 роутера (r1, r2)).
...
#### 5.1. Установка маршрута по-умолчанию
...
##### Пропингуй с ws11 несуществующий IP (например, *10.10.0.111*) с помощью команды:
`ping -c 1 10.10.0.111`
- В отчёт помести скрин с вызовом и выводом использованных команд.
...
##### 1) Отбрасывать все маршрутизируемые пакеты - `iptables --policy FORWARD DROP`.
...
💡 [Нажми сюда](https://forms.yandex.ru/cloud/6418181eeb614624a5cee6b5/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Продукта сделать твоё обучение лучше.
